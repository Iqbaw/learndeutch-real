...
const descriptions: Record<string, string> = {
  "/lesson": "Satu langkah baru hari ini", "/course": "Materi dan empat keterampilan per level", "/exam": "Tugas baru per modul B1–C2", "/roadmap": "Lihat perjalanan 30 harimu", "/review": "Buat kata baru tetap melekat", "/speaking": "Latihan percakapan nyata", "/vocabulary": "Bangun koleksi kosakatamu", "/grammar": "Pahami pola, bukan menghafal", "/errors": "Belajar dari kesalahanmu", "/notes": "Simpan hal yang ingin diingat", "/statistics": "Kenali perkembanganmu", "/mock-test": "Simulasi ringkas untuk fondasi A1",
};
