...
const goals = [
  { label: "Kuliah di Jerman", detail: "Siap untuk babak baru", icon: GraduationCap },
  { label: "Karier & Ausbildung", detail: "Buka lebih banyak kesempatan", icon: Briefcase },
  { label: "Travel & keseharian", detail: "Lebih percaya diri ngobrol", icon: Plane },
  { label: "Belajar hal baru", detail: "Mulai dari rasa penasaran", icon: Heart },
];
